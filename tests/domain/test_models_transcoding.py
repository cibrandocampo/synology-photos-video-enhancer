...
class TestTranscoding:
    ...
    def test_create_transcoding_not_required(self, sample_video):
        """Test creating a Transcoding object with NOT_REQUIRED status."""
        ...
        assert transcoding.original_video == sample_video
        assert transcoding.transcoded_video == placeholder_video
        assert transcoding.status == TranscodingStatus.NOT_REQUIRED
        assert transcoding.configuration is None